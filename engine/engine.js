...
export class TransformComponent extends Component {
  ...
  transformIn(point){
    let newPoint = new TransformComponent(point.x?point.x:0,point.y?point.y:0,point.z?point.z:0,point.rotation?point.rotation:0,point.scale?point.scale:1);
    // rotate
    newPoint.x = point.x * Math.cos(this.rotation) - point.y * Math.sin(this.rotation);
    newPoint.y = point.x * Math.sin(this.rotation) + point.y * Math.cos(this.rotation);
    // translate
    newPoint.x += this.x;
    newPoint.y += this.y;
    newPoint.z += this.z;
